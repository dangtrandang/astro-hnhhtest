      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
        ...
        <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:1}} className="space-y-6">
          <div className="flex items-center gap-3">
            {/* Sacred sun/mystical line-art emblem matching mockup */}
            <svg viewBox="0 0 100 100" className="w-8 h-8 text-[#C5A880]">
            ...
            <h3 className="font-serif text-3xl font-bold text-white tracking-wide">Hồng Ngọc</h3>
          </div>
          ...
          <div className="flex gap-4">
            {/* Facebook Icon */}
            <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 hover:-translate-y-0.5 transition-all duration-300">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            {/* Instagram Icon */}
            <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 hover:-translate-y-0.5 transition-all duration-300">
        ...
        <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:1, delay: 0.3}} className="space-y-6">
          ...
          <form className="flex flex-col gap-3">
            ...
            <button 
              type="button"
              className="px-4 py-3 rounded-xl bg-white text-brand-primary font-bold uppercase tracking-widest text-xs hover:bg-brand-light hover:-translate-y-0.5 active:scale-95 transition-all duration-300"
            >
              Đăng ký ngay
            </button>
          </form>
